...
if(isset($_REQUEST['guardar'])){
    ...
    $query="INSERT INTO proveedor
        (emailProveedor,nombreProveedor,telefonoProveedor,idDireccion) VALUES
        ('".$email."','".$nombre."','".$telefono."','".$idDireccionForanea."')";
    $res=mysqli_query($con,$query);

    if($res){
        echo '<meta http-equiv="refresh" content="0; url=dashboard.php?modulo=proveedores&mensaje=Proveedor creado"/>';
    }else{
        ?>

        <div class="alert alert-danger role="alert>
            Error al crear proveedor <?php echo mysqli_error($con);?>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Crear Proveedor</strong>
                    </div>
                    <div class="card-body">
                        <form action="dashboard.php?modulo=crearProveedor" method="post" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="codigoPostal" class="form-control" required="required">
                            </div>
                            <div class="form-group">
                                <label>Estado</label>
