            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <form action="enviarCorreo.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="Codigo">Enviar codigo de verificación</button>
                        
                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account ? <a href="index.php?modulo=registrarse"> Sign Up Here</a></p>
                        </div>
