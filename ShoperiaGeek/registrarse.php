...
if(isset($_REQUEST['guardar'])){
    ...
    if($res){
        echo '<meta http-equiv="refresh" content="0; url=index.php?modulo=principal&mensaje&mensaje=Usuario creado"/>';
    }else{
        ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="index.php?modulo=registrarse" method="post" required="required">
